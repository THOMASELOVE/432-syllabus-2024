...
The header of our [main website](https://thomaselove.github.io/432-2024/) links to detailed instructions for [Projects](https://thomaselove.github.io/432-2024/projA.html), [Quizzes](https://thomaselove.github.io/432-2024/quiz1.html) and [Labs](https://thomaselove.github.io/432-2024/lab1.html), and the [Minute Paper details](https://github.com/THOMASELOVE/432-minute-2024) are here.

## Deadlines for Assignments

All deadlines are posted as part of the [Course Calendar](https://thomaselove.github.io/432-2024/calendar.html), and the Calendar is the final word for all deadlines.
...
The [Course Calendar](https://thomaselove.github.io/432-2024/calendar.html) provides deadlines for all Labs, and instructions for each Lab are available on [our main website](https://thomaselove.github.io/432-2024/).
...
During the semester, you will have two quizzes to complete. Each quiz is taken online via a Google Form (like the Minute Papers or the [Welcome to 432 survey](https://bit.ly/432-2024-welcome-survey).) Each quiz includes both short-answer and multiple-choice items. The quizzes focus on whether you can apply the tools developed in class to address small problems.

The [Course Calendar](https://thomaselove.github.io/432-2024/calendar.html) provides deadlines for each of the Quizzes, and the [main course website](https://thomaselove.github.io/432-2024/) provides links at the top to each Quiz.
...
During the semester, you will have two projects to complete. Complete instructions for [Project A](https://thomaselove.github.io/432-2024/projA.html) and for [Project B](https://thomaselove.github.io/432-2024/projB.html) are available now, through the link at the top of our main course website.

- [Project A](https://thomaselove.github.io/432-2024/projA.html) anticipates you using materials from 431 and from the first 12 classes of 432.
- [Project B](https://thomaselove.github.io/432-2024/projB.html) anticipates you using materials from the entire semester.

The [Course Calendar](https://thomaselove.github.io/432-2024/calendar.html) provides deadlines for all Project elements.
